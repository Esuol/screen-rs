...
pub fn draw_chart<DB: DrawingBackend>(
    ...
    title: &str,
    line_one_color: RGBColor,
    line_two_color: RGBColor,
...
pub fn draw_line_chart(
    ...
    let b = BitMapBackend::new(out_path, (1024, 768)).into_drawing_area();
    b.fill(&background)?;
    draw_chart(b, title, line_one_color, line_two_color)?;

    println!("Image result has been saved to {}", out_path);
